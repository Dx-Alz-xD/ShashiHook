...
FEATURE_LABEL: dict[str, str] = {
    ...
    "sty_scored": "enough past mail from this sender to compare writing style",
    "sty_drift": "how far this message departs from how this sender normally writes",
...
DIRECT_INDICATORS: frozenset[str] = frozenset({
    ...
    "thr_claims_thread", "thr_msgid_resolved", "thr_fabricated", "sty_scored",
